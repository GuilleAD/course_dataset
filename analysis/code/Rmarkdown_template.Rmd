...
<head>
	...
	<meta name="twitter:image:src" content="https://diytranscriptomics.com">
	...
	<meta property="og:image" content="https://diytranscriptomics.com" />
...
<body class="loading ajax-loading" data-site-url="https://diytranscriptomics.com" data-page-url="/Code/files/Rmarkdown_template.Rmd">
			...
			<div class="menu__wrap">
				<ul class="menu__list">
					...
					<li class="menu__list__item">
						<a href="/" class="menu__list__item__link">Lectures</a>
					</li>
					...
					<li class="menu__list__item">
						<a href="/faqs" class="menu__list__item__link">FAQs</a>
					</li>
					
					<li class="menu__list__item">
						<a href="/community" class="menu__list__item__link">Community</a>
					</li>
					
					<li class="menu__list__item">
						<a href="/learnr/" class="menu__list__item__link">Learn R!</a>
					</li>
...
```
	...
	<div class="wrap">
		...
		<div class="footer__copyright">
			<span>© 2026 DIY.transcriptomics</span>
			<a href="https://hostmicrobe.org" target="_blank">Daniel Beiting</a>
		</div>
