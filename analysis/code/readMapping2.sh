...
# (removed temporarily) fastqc *.gz -t 8
...
# the .gz part in the code line below was removed because Ubuntu said it cannot find the fasta file Homo_Sapiens(...).all.fa.gz
